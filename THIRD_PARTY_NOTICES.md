...
- [ONNX Runtime](https://onnxruntime.ai/) — MIT License; runs the local segmentation model.
- [U²-Net](https://github.com/xuebinqin/U-2-Net) — Apache License 2.0. The compact `u2netp` ONNX model is used for local salient-object segmentation. The distributed model is verified against the checksum published by the rembg project.
